...
export default function MyOrder() {
    ...
    const fetchMyOrder = async () => {
        ...
        await fetch("https://backend-pearl-tau.vercel.app/api/myOrderData", {
            // credentials: 'include',
                                ...
                                data.orderData.order_data.slice(0).reverse().map((item) => {
                                    return (
                                        item.map((arrayData) => {
                                            return (
                                                <div>
                                                    {arrayData.Order_date ? <div className='m-auto mt-2'>

                                                        {data = arrayData.Order_date}
                                                        <hr />
                                                    </div> :
                                                        <div className='d-flex'>
                                                            <div className='mt-3 col-12 col-md-6 col-lg-3 d-flex'>
                                                                <div className="card mt-3 col-12 col-md-6 col-lg-3 d-flex" style={{ width: "16rem", height: "350px" }}>
                                                                    ...
                                                                    <div className="card-body">
                                                                        ...
                                                                        <div className='container w-100 p-0' style={{ height: "38px" }}>
                                                                            ...
                                                                            <span className='m-1'>Size:{arrayData.size}</span><br />
                                                                            {/* <span className='m-1'>{data}</span> */}
                                                                            <div className=' d-inline ms-2 h-100 w-20 fs-5' >
                                                                                Total Price:₹{arrayData.price * arrayData.qty}/-
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
